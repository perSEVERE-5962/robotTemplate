...
public class PathFollow extends CommandBase {
  ...
  final double kV = 1/12.5;//1/22.72;
  final double kA = 1/71.01;//1/72.29;
  ...
  public PathFollow(Drive drive, PIDControl configTalon, AHRS gyro)
   {
    ...
    leftFollower = follower(Pathfinder.readFromCSV(new File("/home/lvuser/deploy/path23_left.csv")));
    //add left location
    rightFollower = follower(Pathfinder.readFromCSV(new File("/home/lvuser/deploy/path23_right.csv")));   
